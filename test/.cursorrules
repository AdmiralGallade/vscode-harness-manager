...
> **Harness Manager** — active harness: `dev-wiki`  
> Category: workflow · Version: 2.0.0 · Author: j-wanger (https://github.com/j-wanger/dev-wiki)
> Tags: claude-code, workflow, lifecycle, wiki, tasks, hooks, skills

## Description

Phase-based project lifecycle system for Claude Code. Tracks phases, decisions, tasks, and knowledge across sessions using a local .dev-wiki/ directory. Includes skills, hooks, and rules for session continuity, TDD task tracking, and architecture scanning.

## Harness Location

Files are installed at `./agent-harnesses/dev-wiki/`:
- `agent-harnesses/dev-wiki/hooks/dev-wiki-post-commit.sh`
- `agent-harnesses/dev-wiki/hooks/dev-wiki-scope-check.sh`
- `agent-harnesses/dev-wiki/hooks/session-start.sh`
- `agent-harnesses/dev-wiki/hooks/session-stop.sh`
- `agent-harnesses/dev-wiki/hooks/stale-queue.sh`
- `agent-harnesses/dev-wiki/README.md`
- `agent-harnesses/dev-wiki/rules/dev-wiki-hooks.md`
- `agent-harnesses/dev-wiki/skills/dev-check/SKILL.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/active-knowledge-transition.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/architecture-staleness-check.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/claude-md-refresh.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/debrief-finalization.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/quick-debrief-flow.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/retro-check.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/review-gate.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/reviewer-prompt.md`
- `agent-harnesses/dev-wiki/skills/dev-debrief/SKILL.md`
- `agent-harnesses/dev-wiki/skills/dev-init/init-scaffolding.md`
- `agent-harnesses/dev-wiki/skills/dev-init/scaffold-claude-md.md`
- `agent-harnesses/dev-wiki/skills/dev-init/SKILL.md`
- `agent-harnesses/dev-wiki/skills/dev-init/templates/AGENTS.md`
- `agent-harnesses/dev-wiki/skills/dev-init/templates/project-CLAUDE.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/approach-reviewer-prompt.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/compaction-anchors-spec.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/implementation-guide.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/iterative-retrieval-spec.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/plan-reviewer-prompt.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/research-pause-spec.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/self-check-checklist.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/SKILL.md`
- `agent-harnesses/dev-wiki/skills/dev-plan/task-schema.md`
- `agent-harnesses/dev-wiki/skills/dev-scan/architecture-prompt.md`
- `agent-harnesses/dev-wiki/skills/dev-scan/content-hashing.md`
- `agent-harnesses/dev-wiki/skills/dev-scan/file-prompt.md`
- `agent-harnesses/dev-wiki/skills/dev-scan/module-prompt.md`
- `agent-harnesses/dev-wiki/skills/dev-scan/python-memory-checks.md`
- `agent-harnesses/dev-wiki/skills/dev-scan/python-scan-profile.md`
- `agent-harnesses/dev-wiki/skills/dev-scan/refresh-flow.md`
- `agent-harnesses/dev-wiki/skills/dev-scan/SKILL.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/active-knowledge-spec.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/architecture-template.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/claude-md-lifecycle.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/decision-template.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/journal-templates.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/phase-template.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/size-budgets.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/SKILL.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/slugification.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/stale-queue-spec.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/state-template.md`
- `agent-harnesses/dev-wiki/skills/dev-wiki/working-knowledge-spec.md`

## Instructions
# dev-wiki

> **Attribution:** This harness is sourced from [j-wanger/dev-wiki](https://github.com/j-wanger/dev-wiki) by [@j-wanger](https://github.com/j-wanger), used under the MIT License. No modifications have been made to the original files.
